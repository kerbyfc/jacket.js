(function(){
    ...
    Jacket = (function() {
        ...
        Jacket.argv = function(fname, obj, extentions, methods, callback) {
            ...
            } else if (typeof methods === 'string' && methods.match(/^r\/.*\/([igm]*)?$/) !== null && (fIndex = _.lastIndexOf(methods, '/'))) {
                try {
            ...
            return [fname, obj, extentions, methods, callback]
        }
        ...
        function Jacket(fname, obj, extentions, methods, callback) {
            ...
            if (typeof root._ === "undefined") {
                ...
                a = Jacket.argv.apply(this, Array.prototype.slice.call( Jacket.Helpers.isArguments(a[0]) ? a[0] : a));
            }

            if (this instanceof Jacket) {

                return function() {
                    return new (new Jacket.Wearer( a[1], a[2], a[4], a[3], a[0], arguments ))();
                };

            } else {
                return new Jacket.Wearer( a[1], a[2], a[4], a[3], a[0] );
            }
    ...
    Jacket.Wearer = (function() {
        ...
        function Wearer(origin, extentions, callback, methods, fname, args) {
...
//            console.log("WRAP CLASS", this.fname, typeof this.origin);
        ...
        Wearer.prototype.getCall = function(scope, prop) {
            ...
            return {method: prop, callee: name, caller: name + ( prop ? '.' + prop : ''), scope: scope, time: new Date().getTime()};
        };
        ...
        Wearer.prototype.wrap = function(prop, value, force) {
            ...
            if (typeof value === 'function' && !_.has(value, "wrapped") && (force || ( _.isArray(this.methods) && _.indexOf(this.methods, prop) < 0) || (this.methods instanceof RegExp && this.methods.test(prop)) )) {
                ...
                var jacket = function() {
                    ...
                    var call = _.extend( _jacket.getCall(this, prop), {args: arguments} );
